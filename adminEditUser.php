    ...
    <div class="main--content">
        <div class="passwordForm">
            ...
            <div class="container">
                ...
                <form action="components/adminChangePassword.php?username=<?php echo $userName; ?>" method="POST" class="addContact">
        ...
        <div class="passwordForm">
            ...
            <div class="container">
                <form action="components/adminEditProfile.php?username=<?php echo $userName; ?>" method="POST" class="addContact" enctype="multipart/form-data">
                    <?php
