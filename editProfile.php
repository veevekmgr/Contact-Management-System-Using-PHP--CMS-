...
if (isset($_POST['submit-image'])) {
    ...
    if (empty($images)) {
        echo "<script> alert('Nothing to Update');document.location='setting.php';</script>";
    } else {
        ...
        echo "<script> alert('Profile Image Updated');document.location='setting.php';</script>";
    }
}
...
if (isset($_POST['submit-document'])) {
    ...
    if (empty($document)) {
        ...
        echo "<script> alert('User Document Updated');document.location='setting.php';</script>";
    }
}
...
if (isset($_POST['submit'])) {
    ...
    if ($fullname == $dbfullname && $contact == $dbcontact && $email == $dbemail) {
        ...
        echo "<script> alert('Updated');document.location='setting.php';</script>";
        die();
    }
}
