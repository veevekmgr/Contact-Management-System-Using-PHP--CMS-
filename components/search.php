            ...
            if ($row > 0) {
                while ($row_Contacts = $stmt_sql->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href='components/viewContactDoc.php?username=<?php echo $row_Contacts['contactname']; ?>' class="btn-action btn-1">View Document</a>
                            <a href='components/deleteContact.php?id=<?php echo $row_Contacts['id']; ?>' class="btn-action btn-2">Delete</a>
                            <a href='components/editContact.php?id=<?php echo $row_Contacts['id']; ?>' class="btn-action btn-3">Edit</a>
                        </td>
                    </tr>
        <?php  }
                //If no result found
...
<tbody>
    <?php
        ...
        <tr>
            ...
            <td>
                <a href='components/viewContactDoc.php?username=<?php echo $row_Contact['contactname']; ?>' class="btn-action btn-1">View Document</a>
                <a href='components/deleteContact.php?id=<?php echo $row_Contact['id']; ?>' class="btn-action btn-2">Delete</a>
                <a href='components/editContact.php?id=<?php echo $row_Contact['id']; ?>' class="btn-action btn-3">Edit</a>
            </td>
        </tr>
    <?php }
    ?>
