...
if (isset($_POST['submit'])) {
    ...
    if (strlen($newPassword) < 8 && empty($newPassword)) {
        ...
        if ($newPassword == $confirmPassword) {
            ...
            echo "<script> alert('Password Changed!');document.location='../adminUser.php';</script>";
            die();
        } else {
            echo "<script> alert('New Password doesnot match!');document.location='../adminUser.php';</script>";
            die();
        }
    } else {
        echo "<script> alert('New Password doesnot match!');document.location='../adminUser.php';</script>";
